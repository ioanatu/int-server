...
4.  <del>instantiate a git repository called `intNext` in Desktop/code and create the server project in a new directory called `int-server` in in Desktop/code/intNext</del>create a directory `intNext` in Desktop/code and in it instantiate a git repository called`int-serve`
5.  expose the following endpoints delivering the data from the two files suppliers and supplier:
    - GET /api/v1/suppliers
    - GET /api/v1/suppliers/{supplierId}
6.  <del>move this md file to the intNext directory and call it`server-requirement`</del>move this md file to the `int-server` directory and call it “server-requirements”
...
10. OpenAPI should be supported and swagger documentation generated similar to the one here: https://jean-test-api.herokuapp.com/api-docs
